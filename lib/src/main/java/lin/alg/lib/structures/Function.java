...
public abstract class Function {
    ...
    public final void manuallySetIntegral(Function integral) {
        this.integral = integral;
    }

    public final Function getManuallySetIntegral() {
        return integral;
    }
    ...
    public final double definiteIntegral(double a, double b) {
        if (integral != null) {
    ...
    private double[][] quadratureCoefficients(int n) {
        switch (n) {
            case 2:
                return new double[][] {
